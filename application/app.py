...
def get_score_data():
    data = request.json
    act_low = data['act_low'] if data['act_low'] != '' else 0
    act_high = data['act_high'] if data['act_high'] != '' else 36
    act = data['act']
    sat_low = data['sat_low'] if data['sat_low'] != '' else 0
    sat_high = data['sat_high'] if data['sat_low'] != '' else 1600
    sat = data['sat']
    both = data['both']
